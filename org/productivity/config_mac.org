...
#+END_SRC
** Enable accessiblity
Amethyst must be given permissions to use the accessibility APIs under the Privacy tab of the Security & Privacy preferences pane 

** Set first modifier to Hypher
TBD
