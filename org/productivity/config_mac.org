...
Do you miss *aplt-get*, or any package manager on Linux after you swtiched to Mac?
If you do then [[http://brew.sh][HomeBrew]] and [[https://caskroom.github.io/][HomeBrew Cask]] 
...
#+END_SRC
* Better Terminal
Iterm2 has a lot useful [features](https://www.iterm2.com/features.html), such as split panes, 
hotkey window.
...
Register a hotkey that brings iTerm2 to the foreground when you're in another application. 
A terminal is always a keypress away. This gives you an always-available terminal (like Visor, Guake, or Yakuake) 
at your fingertips.
...
* Use Spacemacs
Emacs default configuration is, well, not really easy to use, so you need to spend a lot of time to 
config it. I used to have a big configuration until I found spacemacs.

The most favaor part of Spacemacs is it can be used naturally by both Emacs and Vim users, the second 
part is its shortcuts is god damm easy to remeber. ok, some people might not agree, but at least it is easy to 
remeber than Emacs's.
...
* References
- [[http://sourabhbajaj.com/mac-setup/Xcode/README.html][Mac OS X Setup Guide]]
