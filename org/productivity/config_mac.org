...
#+END_QUOTE
* Manageing dotfiles in org-babel.
I used to have almost 80% configuration that I stole from other people on internet which is never 
used. Why? Maybe because I did not think why i need them, thoese things does not be adopted in my daily 
workflow. 
